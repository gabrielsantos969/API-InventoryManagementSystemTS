...
import { getAll, getByEmail, getById, getByName, getByUsername, create, update, deleteUser } from "../controllers/userController";
...
router.delete('/v1/delete/:id', deleteUser);
