...
import { getProductCode, getProductId, getProductName, getProducts, productCreate, productDelete, productUpdate } from "../controllers/productController";
...
router.get('/v1/getProductByName/:name', getProductName);
